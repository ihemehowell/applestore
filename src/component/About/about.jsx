...
const about = () => {
  return (
    <div>
        ...
        <div className="row">
            <h1 className="text-warning fw-bold mb-4 text-center ">About us </h1>
            <hr/>
        <div className="col-md-6 d-flex flex-column justify-content-center align-content-center text-center">
        ...
        <Link to='/contact' className='btn btn-outline-warning px-3 '>Contact us</Link>
